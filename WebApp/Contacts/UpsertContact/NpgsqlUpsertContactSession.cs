...
public sealed class NpgsqlUpsertContactSession : AsyncNpgsqlSession, IUpsertContactSession
{
    ...
    public NpgsqlUpsertContactSession(NpgsqlConnection connection) : base(connection) { }
    ...
    )
    {
        ...
        command.Parameters.Add(
            new NpgsqlParameter { Value = addressIds, NpgsqlDbType = NpgsqlDbType.Array | NpgsqlDbType.Uuid }
        );
    ...
    private static async Task<Dictionary<Guid, Address>> DeserializeAddressesAsync(
    ...
    )
    {
        ...
        while (await reader.ReadAsync(cancellationToken))
        {
            ...
            addresses.Add(id, new Address(id, contactId, street, zipCode, city));
        }
